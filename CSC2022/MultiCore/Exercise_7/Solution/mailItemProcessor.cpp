...
g++ mailItemProcessor.cpp -o mailItemProcessor -std=c++17 -fgnu-tm -pthread
*/
#include <chrono>
#include <functional>
#include <iostream>
...
TsQueue<mailItem> * gSentMailItemsQueue;
//------------------------------------------------------------------------------
...
int main(int argc, char ** argv) {
  ...
  gSentMailItemsQueue = new TsQueue<mailItem>(nItems);
